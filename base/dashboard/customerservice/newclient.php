...
<head>
  ...
  <title>New Client | Customer Service Dashboard </title>
      ...
      <div class="panel" style="width: 75%">
        ...
        <div class="panel-body">
              ...
              <form class="">
                      ...
                      <div class="form-group">
                          <input type="text" class="form-control" name="town" id="town" placeholder="Town" autocomplete="off">
                      </div>
                      <div class="form-group">
                        <div id="responsesection"></div>
                       <a href="#" type="submit" id="newclient" class="btn btn-primary">Add Client</a>
                      </div>
          </form>
      ...
      $.post("../addclient.php",
        {
          ...
          $('#newclient').html('Add Client');

          if (ajaxresponse == "<h5 style='color:green'><i class='fa fa-check-circle'>The client has been added.</h5>") 
          { 
            window.location.assign("http://dotskenya.com/system/base/dashboard/frontoffice/client.php");
          }
        });
    });
  });
