...
<head>
  ...
  <title>New Quotation | Customer Service Dashboard </title>
...
<body class="animsition">
  ...
  <div class="page">
    ...
    <div class="page-content" style="background-image: url('../../assets/images/bac.jpg');">
      <!-- Panel Table Tools -->
      <div class="panel" style="width: 75%">
        ...
        <div class="panel-body">
           ...
           <form class="">
                      ...
                      <div class="form-group">
                          <textarea cols="80" rows="3" class="notes" id="job_description" placeholder="Job Description"></textarea>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <a href="#" type="submit" id="generateQ" class="btn btn-primary">Generate Quotation</a>
                      </div>
          </form>
  ...
  $(document).ready(function()
  {
    ...
    {
      $('#generateQ').html('<i class="fa fa-refresh fa-spin"></i> Please wait');
      ...
      $.post("generatequote.php",
        {
          ...
          $('#generateQ').html('Generate Quotation');

          if (ajaxresponse == "<h5 style='color:green'><i class='fa fa-check-circle'>Your quotation has been generated.</h5>") 
          { 
