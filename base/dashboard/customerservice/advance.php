...
$query = mysql_query("SELECT * FROM `advance` WHERE `username`= '{$_SESSION['GuyJob2']}'");
  ...
  <div class="page">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <input type="button" class="btn btn-sm btn-danger" style="margin-top: 10px;" value="Apply for Advance" onclick="window.location.href='advanceapplication.php'" />
