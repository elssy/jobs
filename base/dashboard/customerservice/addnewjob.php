...
<head>
  ...
  <title>New Job | Customer Service Dashboard </title>
          ...
          $.post("newjob.php",
            {
              ...
              { 
                window.location.assign("http://dotskenya.com/system/base/dashboard/frontoffice/index.php");
              }
            });
        });
      });
