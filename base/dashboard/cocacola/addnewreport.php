...
<head>
  ...
  <title>New Report | Cocacola Dashboard </title>
...
<body class="animsition">
        ...
        <div class="panel-body">
          ...
          <form class="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group ">
                        <input type="text" class="form-control" name="project_title" id="project_title" placeholder="Project Title" autocomplete="off">
                      </div>
                      ...
                      <div class="form-group ">
                        <input type="text" class="form-control" name="flavour" id="flavour" placeholder="Flavour" autocomplete="off">
                      </div>

                      <div class="form-group ">
                        <input type="text" class="form-control" name="packtype" id="packtype" placeholder="Park Type" autocomplete="off">
                      </div>
                    
                      
                      <div class="form-group">
                        <textarea cols="80" rows="5" class="notes" id="remarks" placeholder="Remarks"></textarea>
                      </div>
                      
                      <div class="form-group">
                        <div id="responsesection"></div>
                        <a href="#" type="submit" id="savereport" class="btn btn-primary">Save Report</a>
                      </div>
          </form>
  ...
  $(document).ready(function()
  {
    ...
    {
      $('#savereport').html('<i class="fa fa-refresh fa-spin"></i> Please wait');
      ...
      $.post("savereport.php",
        {
          ...
          $('#savereport').html('Send Application');
