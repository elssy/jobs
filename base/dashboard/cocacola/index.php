...
$query = mysql_query("SELECT * FROM `cocacola` ");
...
<head>
  ...
  <title>Status Report | Cocacola </title>
  ...
  <div class="page">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Cocacola</a></li>
        <li class="breadcrumb-item active">Status Reports</li>
      </ol>
       <input type="button" class="btn btn-sm btn-danger" style="margin-top: 10px;" value="Add new Report" onclick="window.location.href='addnewreport.php'" />
    </div>
             ...
             <tbody>
                      ...
                      <?php
                         while($rdata  = mysql_fetch_array($query)){
                          $id          = $rdata['id'];
                          $date        = $rdata['date'];
                          $logged      = $rdata['report_by'];
                          $country     = $rdata['country'];
                          $project     = $rdata['project'];
                          $brand       = $rdata['brand'];
                          $flavour     = $rdata['flavour'];
                          $packtype    = $rdata['packtype'];
