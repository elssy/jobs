...
<head>
  ...
  <title>Cocacola Dashboard </title>
...
<body class="animsition">
  ...
  <div class="page">
    <div class="page-header">
      ...
      <a type="submit" href="addnewreport.php" class="btn btn-sm btn-danger" style="margin-top: 10px;">Add new Report <i class="fa fa-plus"></i></a>
    </div>
