      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar">
          ...
          <li style="margin-top: 19px; font-size: 20px;">
            <label><b>Quality Control Department</b></label>
          </li>
      ...
      <div>
        <div>
          <ul class="site-menu" data-plugin="menu">
            <li class="site-menu-category">Quality Control Management</li>
            ...
            <li class="site-menu-item">
                  <a class="animsition-link" href="awaiting.php">
                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                    <span class="site-menu-title">  Awaiting Quality check</span>
                    
                  </a>
            </li>
            <li class="site-menu-item">
                  <a class="animsition-link" href="dispatched.php">
                    <i class="fa fa-edit" aria-hidden="true"></i>
                    <span class="site-menu-title">Sent to Dispatch</span>
