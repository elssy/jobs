<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar">
          ...
          <li style="margin-top: 19px; font-size: 20px;">
            <label><b>Sales & Marketing Department</b></label>
          </li>
  ...
  <div class="site-menubar">
      ...
      <div>
        <div>
          <ul class="site-menu" data-plugin="menu">
            <li class="site-menu-category">Sales & Marketing Management</li>
            <li class="site-menu-item">
              <a href="index.php">
                <i class="fa fa-dashboard" aria-hidden="true"></i>
                <span class="site-menu-title">All Reports</i></span>
    ...
    <div class="site-menubar-footer">
      <a href="addsales.php" data-placement="top" data-toggle="tooltip" data-original-title="Add new Report">
