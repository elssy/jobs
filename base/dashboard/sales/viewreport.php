...
$query       = mysql_query("SELECT * FROM `sales_report` WHERE `id`= '$id' ");
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          ...
          <div class="text-left clearfix">
            ...
            <hr>
            <div class="">
              <h4 style="font-size: 15px;">Description of the meeting</h4>
                <p style="text-align: left;">
                <?php echo $description_meeting ?> <br>
            ...
            <hr>
             <div class="">
              <h4 style="center; font-size: 15px;">Comments</h4>
                <p style="text-align: left;">
            ...
            <div class="" style="width:75%;">
              <p><b>Next Follow Up</b><br>
                <span><?php echo $follow_up; ?></span>
              </p>
              
            </div>
            <hr>
          </div>
           <b>Prepared  by: <?php echo $_SESSION['GuyJob8']; ?> </b>
