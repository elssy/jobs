...
<head>
  ...
  <title>Advance Appliction Design</title>
...
<body class="animsition">
    ...
    <div class="page-content">
      ...
      <div class="panel" style="width: 75%">
        <header class="panel-heading">
          <h3 class="panel-title">Advance Application</h3>
        </header>
        <div class="panel-body">
            ...
            <form class="">
                      ...
                      <div class="form-group">
                         <textarea cols="80" rows="3" class="notes" id="reason" placeholder="Reason"></textarea>
                      </div>
                      <div class="form-group">
                        <div id="responsesection"></div>
                        <a href="#" type="submit" id="send" class="btn btn-primary">Send Application</a>
                      </div>
          </form>
  ...
  $(document).ready(function()
  {
    $('#send').click(function()
    {
      $('#send').html('<i class="fa fa-refresh fa-spin"></i> Please wait');

      var amount       =  $('#amount').val();
      var reason       =  $('#reason').val();
      
      $.post("sendapplication-advance.php",
        {
          amount:amount,
          reason:reason
          ...
          $('#send').html('Send Application');

          if (ajaxresponse == "<h5 style='color:green'><i class='fa fa-check-circle'>Your application has been sent.</h5>") 
          { 
            window.location.assign("http://dotskenya.com/system/base/dashboard/frontoffice/advance.php");
          }
        });
    });
  });
