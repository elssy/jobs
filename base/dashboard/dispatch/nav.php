      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar">
          ...
          <li style="margin-top: 19px; font-size: 20px;">
            <label><b>Dispatch Department</b></label>
          </li>
      ...
      <div>
        <div>
         <ul class="site-menu" data-plugin="menu">
            <li class="site-menu-category">Dispatch Management</li>
            <li class="site-menu-item">
              <a href="index.php">
                <i class="fa fa-dashboard" aria-hidden="true"></i>
                <span class="site-menu-title">All job</i></span>
            ...
            <li class="site-menu-item">
              <a href="other.php">
                <i class="fa fa-dashboard" aria-hidden="true"></i>
                <span class="site-menu-title">Errands for Dispatch</i></span>
