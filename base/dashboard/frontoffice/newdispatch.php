...
<head>
  ...
  <title>New Dispatch Job | Front Office Dashboard </title>
...
<body class="animsition">
    ...
    <div class="page-content">
      ...
      <div class="panel" style="width: 75%">
        <header class="panel-heading">
          <h3 class="panel-title">Add a New Dispatch</h3>
        </header>
        <div class="panel-body">
            ...
            <form class="">
                      ...
                      <div class="form-group">
                          <select class="form-control" id="dispatchType">
                      ...
                      <div class="form-group">
                          <input type="text" class="form-control" name="item" id="item" placeholder="Item" autocomplete="off">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <a href="#" type="submit" id="sendDispatch" class="btn btn-primary">Add Job to Dispatch</a>
                      </div>
          </form>
  ...
  $(document).ready(function()
  {
    $('#sendDispatch').click(function()
    {
      $('#sendDispatch').html('<i class="fa fa-refresh fa-spin"></i> Please wait');
      ...
      $.post("sendDispatch.php",
        {
          ...
          $('#sendDispatch').html('Add Job to Dispatch');

          if (ajaxresponse == "<h5 style='color:green'><i class='fa fa-check-circle'>Your delivery has been sent.</h5>") 
          { 
            window.location.assign("http://dotskenya.com/system/base/dashboard/frontoffice/dispatch.php");
          }
        });
    });
  });
