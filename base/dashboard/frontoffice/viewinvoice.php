...
$query       = mysql_query("SELECT * FROM `invoice` WHERE `id`= '$id'");

 while($rdata  = mysql_fetch_array($query)){
        $date        = $rdata['date'];
        $due_date    = $rdata['due_date'];
        $thename     = $rdata['name'];
        $lpo         = $rdata['lpono'];
        $terms       = $rdata['terms'];
        $job         = $rdata['job'];
        ...
        <div class="panel-body container-fluid">
          <div class="row">
            ...
            <div class="col-lg-3 offset-lg-6 text-right">
              <h4>Invoice Info</h4>
              <p>
                <a class="font-size-20" href=""> #<?php echo $id; ?></a>
                <br> To:
                <br>
              ...
              <span><b>Invoice Date: <?php echo $date; ?></b></span>
              <br>
            ...
            <table class="table table-hover text-right">
              <thead>
                <tr>
                  ...
                  <th class="text-right">Terms of Payment</th>
          ...
          <div class="text-left clearfix">
            ...
            <div class="float-right">
              ...
              <p>Sub - Total amount:
                <span style="float:right;"><b><?php echo $subtotal; ?></b></span>
              </p>
              <p>VAT:
                <span style="float:right;"><b><?php echo $tax; ?></b></span>
              </p>
              <p class="page-invoice-amount">Grand Total:
                <span style="float:right;"><b>KES. <?php echo $total;?></b></span>
              </p>
            </div>
