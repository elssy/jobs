...
$query = mysql_query("SELECT * FROM `jobs` WHERE `user`='{$_SESSION['GuyJob7']}' && `status`='Ongoing' order by id DESC");
...
<head>
  ...
  <title>Ongoing Jobs | Production Dashboard </title>
...
<body class="animsition">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Ongoing Jobs</h1>
      <ol class="breadcrumb">
