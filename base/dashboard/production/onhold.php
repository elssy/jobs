...
$query = mysql_query("SELECT * FROM `jobs` WHERE `user`='{$_SESSION['GuyJob7']}' && `status`='Onhold' order by id DESC");
...
<head>
  ...
  <title>Onhold Jobs | Production Dashboard </title>
...
<body class="animsition">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">On Hold Jobs</h1>
      <ol class="breadcrumb">
